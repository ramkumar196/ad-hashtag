...
static urlValidator(url): any {
   ...
   const URL_REGEXP = /^(http?|https?):\/\/([a-zA-Z0-9.-]+(:[a-zA-Z0-9.&%$-]+)*@)*((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]?)(\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])){3}|([a-zA-Z0-9-]+\.)*[a-zA-Z0-9-]+\.([a-zA-Z]{2,8}))(:[0-9]+)*(\/($|[a-zA-Z0-9.,?'\\+&%$#=~@_-]+))*$/;
   url.markAsTouched();
